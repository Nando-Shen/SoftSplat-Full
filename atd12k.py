...
class ATD12k(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            return torch.stack([images[0], images[2]], dim=1), images[1], 0.5, self.data_list[index][3]
        else:
            T = self.transforms
...
def get_loader(mode, data_root, batch_size, shuffle, test_mode=None):
    ...
    return DataLoader(dataset, batch_size=batch_size, shuffle=shuffle, pin_memory=True), dataset.__len__()
